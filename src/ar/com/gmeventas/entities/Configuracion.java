...
public class Configuracion {
    ...
    public Configuracion(Long id, Float iva, Integer sucursalA, Integer numeroFacturaA, Integer sucursalB, Integer numeroFacturaB, Integer numeroNotaCreditoB, Integer numeroRecibo, Integer numeroPedido, Float ivaPan, Date ultimaFecha, Date ultimaFechaPanificados, Integer numeroRemito) {
        this.id = id;
        this.iva = iva;
