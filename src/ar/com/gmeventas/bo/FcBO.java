...
public class FcBO {
    ...
    public void deleteAllFacturasCompletas() throws Exception {
        RenglonFcBO rFcBo = new RenglonFcBO();
        FcBO fcBo = new FcBO();
        List<RenglonFc> renglones;
        List<Factura> facturas;
        renglones = rFcBo.getAllrenglones();
        for (RenglonFc r : renglones) {
            rFcBo.deleteRenglon(r);
        }
        facturas = fcBo.getAllFacturas();
        for (Factura f : facturas) {
            fcBo.deleteFactura(f);
        }
    }
