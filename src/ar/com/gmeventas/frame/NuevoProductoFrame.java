...
public class NuevoProductoFrame extends javax.swing.JFrame {
    ...
    public NuevoProductoFrame() {
        ...
        this.borrarCampos();
        panificadoChk.setSelected(false);
        panificadoChk.setEnabled(false);
        fabricacionChk.setSelected(false);
        fabricacionChk.setEnabled(false);
        this.llenarComboRubro();
        this.llenarComboSubRubro();
        idTxt.setText(String.valueOf(buscarSiguiente()));
    ...
    private void initComponents() {
        ...
        panificadoChk = new javax.swing.JCheckBox();
        comboAlic = new javax.swing.JComboBox<>();
        jLabel15 = new javax.swing.JLabel();
        fabricacionChk = new javax.swing.JCheckBox();
        ...
        panificadoChk.setText("Panificado");

        comboAlic.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel15.setText("Alícuota Iva:");

        fabricacionChk.setText("Fabricación");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(137, 137, 137)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(fabricacionChk)
                                            .addComponent(panificadoChk))))
                                .addGap(0, 34, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(comboAlic, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(comboAlic, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel15)
                    .addComponent(fabricacionChk))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void volerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_volerBtnActionPerformed
        AbmProductosInactivosFrame abmProductoFrame = new AbmProductosInactivosFrame(filtro);
    ...
    private javax.swing.JComboBox<String> comboAlic;
    private javax.swing.JComboBox comboRubro;
    private javax.swing.JComboBox comboSubRubro;
    private javax.swing.JCheckBox fabricacionChk;
    ...
    private javax.swing.JCheckBox panificadoChk;
    ...
    private void guardar() {
        if (validarCampos()) {
            ...
            int row = comboAlic.getSelectedIndex() - 1;
            AlicuotaIva ai = alicuotas.get(row);
            producto.setAlicuotaIva(ai);
            ...
            if (panificadoChk.isSelected()) {
                producto.setPanificado(true);
            } else {
                producto.setPanificado(false);
                producto.setFabricado(false);
                fabricacionChk.setSelected(false);
            }
            if(fabricacionChk.isSelected()){
                producto.setFabricado(true);
            }else{
                producto.setFabricado(false);
            }
    ...
    private void borrarCampos() {
        ...
        precioCostoTxt.setVisible(false);
        impuestoCostoTxt.setVisible(false);
        jLabel7.setVisible(false);
        sugeridoTxt.setVisible(false);
    }
    ...
    private void llenarComboSubRubro() {
        ...
        // llenar combo alicuota iva
        alicuotas = null;
        comboAlic.removeAllItems();
        comboAlic.addItem("");
        try {
            alicuotas = new AlicuotaIvaService().getAllAlicuotaIva();
        } catch (Exception ex) {
            Logger.getLogger(NuevoProductoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (alicuotas != null && !alicuotas.isEmpty()) {
            for (AlicuotaIva ai : alicuotas) {
                comboAlic.addItem(ai.getCodigo() + "  -  " + ai.getAlicuota() + "%");
            }
        }
        fabricacionChk.setSelected(false);
        comboAlic.setSelectedIndex(3);
        comboAlic.setEnabled(false);
    }
    ...
    private boolean validarCampos() {
        ...
        if (comboAlic.getSelectedIndex() < 1) {
            JOptionPane.showMessageDialog(this, "producto - Seleccione Alicuota Iva");
            comboAlic.requestFocus();
            return false;
        }
        return true;
    }
    ...
    private Integer buscarSiguiente() {
        Integer sig = null;
        try {
            sig = new ProductoService().getUltimoCodigo();
        } catch (Exception ex) {
//            Logger.getLogger(NuevoProductoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (sig != null) {
