...
public class StockPeriodoProductoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "DETALLE", "CANTIDAD", "NETO", "IVA", "IMPUESTO"
            }
        ) {
    ...
    private void buscar() {
        ...
        if (renglones != null && !renglones.isEmpty()) {
            ...
            for (RenglonFactura rf : renglones) {
                ...
                rfs.setGravado(rf.getGravado());
                rfs.setImpuesto(rf.getImpuesto().floatValue());
                rfs.setIva(rf.getIva());
            ...
            for (RenglonFcStock rf : renglonesStock) {
                if (x == 2) {
                    ...
                    if (cod.equals(rf.getCodigo())) {
                        ...
                        o[1] = deta;
                        o[2] = df.format(total);
                        o[3] = df2.format(t_gravado);
                        o[4] = df2.format(t_iva);
                        o[5] = df2.format(t_impuesto);
                        tbl.addRow(o);
                        cod = rf.getCodigo();
                        deta = rf.getDetalle();
                        total = rf.getCantidad();
