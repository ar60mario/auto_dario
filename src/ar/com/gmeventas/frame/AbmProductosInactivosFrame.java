...
import ar.com.gmeventas.frame.ModificarProductoFrame;
import ar.com.gmeventas.frame.NuevoProductoFrame;
...
public class AbmProductosInactivosFrame extends javax.swing.JFrame {
     ...
     */
    public AbmProductosInactivosFrame(String filtro) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbmProductosInactivosFrame(null).setVisible(true);
            }
        });
    }
    ...
    private void llenarTabla() {
        ...
        if (panificadosChk.isSelected()) {
            ...
            try {
                ProductoService productoService = new ProductoService();
                listadoProducto = productoService.getProductosByFiltroAndRubroEliminados(filtro, ru);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "error con la base de datos");
            }
        }
    ...
    private void activar() {
        ...
        if(row < 0){
            JOptionPane.showMessageDialog(this, "DEBE SELECCIONAR EL PRODUCTO A ACTIVAR");
            return;
        }
        Producto p = listadoProducto.get(row);
        p.setInactivo(false);
        int a = JOptionPane.showConfirmDialog(this, "CONFIRMA ACTIVAR EL PRODUCTO?", "Atención", JOptionPane.YES_NO_OPTION);
        if(a==0){
            try {
