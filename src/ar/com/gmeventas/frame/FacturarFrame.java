...
public class FacturarFrame extends javax.swing.JFrame {
    ...
    private final String letraFacturaPapel = "B";
    private String sucursalFacturaPapel = "5";
    ...
    public FacturarFrame() {
        ...
        cigarrillosRb.setVisible(false);
        variosRb.setVisible(false);
        limpiarCampos();
        //go();
    }
    ...
    private void initComponents() {
        ...
        segun2Txt = new javax.swing.JTextField();
        ...
        jLabel3.setText("Segundos entre facturas desde:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(segun2Txt, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(verBtn)
                    .addComponent(jLabel6)
                    .addComponent(segun2Txt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void nuevo2() {
        ...
        if (row < 1) {
            JOptionPane.showMessageDialog(this, "SELECCIONE UN RUBRO PARA FACTURAR");
            return;
        }
        ...
        try {
            if (variosRb.isSelected()) {
                productosTop = new ProductoTopService().getAllProductoVariosTopActivos(ru);
            } else {
                productosTop = new ProductoTopService().getAllProductoTabacoTopActivos2(ru);
            }
        } catch (Exception ex) {
            Logger.getLogger(FacturarFrame.class.getName()).log(Level.SEVERE, null, ex);
...
//                }
            ...
            System.out.println(productosTop);
            JOptionPane.showMessageDialog(this, "NO PUEDE PROCESAR Error leyendo Productos Nro.525");
            return;
        }
...
//            JOptionPane.showMessageDialog(this, "Hello");
    ...
    private javax.swing.JTextField segun2Txt;
    ...
    private void limpiarCampos() {
        ...
        cigarrillosRb.setSelected(true);
        cigarrillosRb.setEnabled(true);
        variosRb.setEnabled(true);
        variosRb.setSelected(false);
        segundosTxt.setText("8");
        segun2Txt.setText("50");
        Long c = 1L;
    ...
    private void confirmar() {
        ...
        int a = verificar();
        if(a == 1){
            JOptionPane.showMessageDialog(this, "ERROR EN FECHAS PARA FACTURAR");
            return;
        }
        ...
        if (fact != null && !fact.isEmpty()) {
            for (Factura f : fact) {
                ...
                if (!segundosTxt.getText().isEmpty()) {
                    if ((!segun2Txt.getText().isEmpty())) {
                        int tim1 = Integer.valueOf(segundosTxt.getText());
                        int tim2 = Integer.valueOf(segun2Txt.getText());
                        do {
                            Random rnd = new Random();
...
//                System.exit(0);
                ...
                if (tst == 0) {
                    ...
                    try {
                        ...
                        Dispatch.put(wsfev1, "Cuit", new Variant("20249273253"));//20249273253
...
//                        System.exit(0);
                        ...
                        if (xxx != 0) {
                            ...
                            String ruta1 = "c:/ventasDA/cmprbt/" + tipoComprob
...
//        System.exit(0);
    ...
    private void ver() {
        ...
        try {
            if (variosRb.isSelected()) {
                products = new ProductoTopService().getAllProductoVariosTopActivos(ru);
            } else {
                products = new ProductoTopService().getAllProductoTabacoTopActivos2(ru);
            }
