...
public class PDFBuilder {
    ...
    public File armarFacturaA(IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        ...
        FileOutputStream ficheroPdf = new FileOutputStream("c:/ventasDA/data/facturas_pdf/" + fileNameFormatted + ".pdf");
        ...
        PdfPCell celdaEncabezado1 = new PdfPCell(new Paragraph("DARIO CESAR ALVAREZ", FontFactory.getFont("arial", 9, Font.BOLD, NEGRO)));
...
//            pdf.add(new Paragraph("ESPACIO EN BLANCO", FontFactory.getFont("arial", 8, PLAIN, FONDO_BLANCO)));
        ...
        com.itextpdf.text.Font font = FontFactory.getFont("C:/ventasDA/ttf/PF_I2OF5_TXT.ttf",
        ...
        return new File("c:/ventasDA/data/facturas_pdf/" + fileNameFormatted + ".pdf");
...
//        pieFc.addCell(pieFc6).setBorder(PdfPCell.NO_BORDER);
    ...
    private String getFileNameFormatted(IvaVentas cons) {
        String tdf = "FC";
        if (cons.getTipoDoc().equals(8)) {
            tdf = "NC";
        }
        SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyy");
        String filename = tdf + "_R_Social_"
