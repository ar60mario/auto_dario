...
public class UtilFrame {
    ...
    private final String qr_ruta = "c:/ventasDA/qr/codigoQR";
    ...
    private final String qr_cuit_emisor = "20249273253"; //SANTORO GASTON MATEO
    private final String qr_ptoVta = "5";
